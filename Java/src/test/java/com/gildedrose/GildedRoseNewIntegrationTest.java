...
class GildedRoseNewIntegrationTest {
    ...
    void normalProductCountdown() {
        ...
        assertThat(itemDay0.sellIn).isEqualTo(2);
        ...
        assertThat(itemDay1.quality).isEqualTo(19);

        // day 2
        app.updateQuality();
        Item itemDay2 = ItemUtil.findItem(NORMAL_PRODUCT, app.getItems());
        assertThat(itemDay2.sellIn).isEqualTo(0);
        assertThat(itemDay2.quality).isEqualTo(18);

        // day 3
        app.updateQuality();
        Item itemDay3 = ItemUtil.findItem(NORMAL_PRODUCT, app.getItems());
        assertThat(itemDay3.sellIn).isEqualTo(-1);
    ...
    void sulfurasProductCountdown() {
        ...
        assertThat(itemDay0.sellIn).isEqualTo(2);
        assertThat(itemDay0.quality).isEqualTo(80);

        // day 1
        app.updateQuality();
        Item itemDay1 = ItemUtil.findItem(ProductConstants.PRODUCT_SULFURAS_HAND_OF_RAGNAROS, app.getItems());
        assertThat(itemDay1.sellIn).isEqualTo(2);
        assertThat(itemDay1.quality).isEqualTo(80);

        // day 2
        app.updateQuality();
        Item itemDay2 = ItemUtil.findItem(ProductConstants.PRODUCT_SULFURAS_HAND_OF_RAGNAROS, app.getItems());
        assertThat(itemDay2.sellIn).isEqualTo(2);
        assertThat(itemDay2.quality).isEqualTo(80);

        // day 3
        app.updateQuality();
        Item itemDay3 = ItemUtil.findItem(ProductConstants.PRODUCT_SULFURAS_HAND_OF_RAGNAROS, app.getItems());
        assertThat(itemDay3.sellIn).isEqualTo(2);
        assertThat(itemDay3.quality).isEqualTo(80);
    }
