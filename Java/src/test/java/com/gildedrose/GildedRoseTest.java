...
class GildedRoseTest {
    ...
    void qualityIsNeverMoreThen50() {
        Item normalProduct = new Item(ProductConstants.PRODUCT_AGED_BRIE, 10, 49);
        GildedRose app = new GildedRose(List.of(normalProduct));

        // Initial state
        Item itemDay0 = findItem(ProductConstants.PRODUCT_AGED_BRIE, app.getItems());
        assertThat(itemDay0.sellIn).isEqualTo(10);
        assertThat(itemDay0.quality).isEqualTo(49);

        // day 1
        app.updateQuality();
        Item itemDay1 = findItem(ProductConstants.PRODUCT_AGED_BRIE, app.getItems());
        assertThat(itemDay1.sellIn).isEqualTo(9);
        assertThat(itemDay1.quality).isEqualTo(50);

        // day 2
        app.updateQuality();
        Item itemDay2 = findItem(ProductConstants.PRODUCT_AGED_BRIE, app.getItems());
    ...
    void agedBrieIncreasesQualityTheOlderItGets() {
        Item normalProduct = new Item(ProductConstants.PRODUCT_AGED_BRIE, 10, 10);
        GildedRose app = new GildedRose(List.of(normalProduct));
        ...
        // day 1
        app.updateQuality();
        Item itemDay4 = findItem(ProductConstants.PRODUCT_AGED_BRIE, app.getItems());
    ...
    void sulfurasIsNeverSoldOrDecreasedInQuality() {
        ...
        // Initial state
        Item itemDay0 = findItem(ProductConstants.PRODUCT_SULFURAS_HAND_OF_RAGNAROS, app.getItems());
        assertThat(itemDay0.sellIn).isEqualTo(10);
        assertThat(itemDay0.quality).isEqualTo(10);

        // day1
        app.updateQuality();
        Item itemDay1 = findItem(ProductConstants.PRODUCT_SULFURAS_HAND_OF_RAGNAROS, app.getItems());
        assertThat(itemDay1.sellIn).isEqualTo(10);
        assertThat(itemDay1.quality).isEqualTo(10);

        // day2
        app.updateQuality();
        Item itemDay2 = findItem(ProductConstants.PRODUCT_SULFURAS_HAND_OF_RAGNAROS, app.getItems());
    ...
    void backStagePassesQualityIncreasesBy2When10DaysOrLess() {
        ...
        // Initial state
        Item itemDay0 = findItem(ProductConstants.PRODUCT_BACKSTAGE_PASSES_TO_CONCERT, app.getItems());
        assertThat(itemDay0.sellIn).isEqualTo(10);
        assertThat(itemDay0.quality).isEqualTo(10);

        // day1
        app.updateQuality();
        Item itemDay1 = findItem(ProductConstants.PRODUCT_BACKSTAGE_PASSES_TO_CONCERT, app.getItems());
        assertThat(itemDay1.sellIn).isEqualTo(9);
        assertThat(itemDay1.quality).isEqualTo(12);

        // day2
        app.updateQuality();
        Item itemDay2 = findItem(ProductConstants.PRODUCT_BACKSTAGE_PASSES_TO_CONCERT, app.getItems());
        assertThat(itemDay2.sellIn).isEqualTo(8);
    ...
    void backStagePassesQualityIncreasesBy3When5DaysOrLess() {
        Item normalProduct = new Item(ProductConstants.PRODUCT_BACKSTAGE_PASSES_TO_CONCERT, 5, 10);
        GildedRose app = new GildedRose(List.of(normalProduct));
    ...
    void backStagePassesQualityDropsTo0WhenConcertIsOver() {
        Item normalProduct = new Item(ProductConstants.PRODUCT_BACKSTAGE_PASSES_TO_CONCERT, 0, 20);
        GildedRose app = new GildedRose(List.of(normalProduct));
